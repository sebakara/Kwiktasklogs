...
use Webkul\Partner\Http\Requests\TagRequest;
use Webkul\Partner\Http\Resources\V1\TagResource;
...
class TagController extends Controller
{
    ...
    #[UrlParam('id', 'integer', 'The tag ID', required: true, example: 1)]
    #[Response(status: 200, description: 'Tag restored successfully', content: '{"message": "Tag restored successfully."}')]
    #[Response(status: 404, description: 'Tag not found', content: '{"message": "Resource not found."}')]
    #[Response(status: 401, description: 'Unauthenticated', content: '{"message": "Unauthenticated."}')]
